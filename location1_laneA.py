...
disp_width = max(1, orig_width - 500)
disp_height = max(1, orig_height - 400)
...
# Load mask image
mask_img = cv2.imread('laneA(2).png', cv2.IMREAD_GRAYSCALE)
if mask_img is None:
    raise FileNotFoundError('Mask image ml2.png not found')
# Create binary mask
...
MOTORBIKE_CONFIDENCE_THRESHOLD = 0.3
...
limitsDown = [514+100, 396+40, 1058+100, 387+40]
# limitsDown = [153-15, 389+15, 599-15, 399+9]
...
while True:
    ...
    # Detect all classes and filter manually on masked image
